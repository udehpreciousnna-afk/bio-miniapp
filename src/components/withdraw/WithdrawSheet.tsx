      ...
      <div style={{
        ...
        {step === 'form' && (<>
          ...
          <div style={{ padding:'8px 20px 24px', display:'flex', flexDirection:'column', gap:16 }}>
            ...
            {/* Balance card — fully responsive for any balance size */}
            <div style={{
              ...
              <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:6 }}>
                <BioIcon size={38}/>
                <p style={{ fontSize:10, fontWeight:700, color:'rgba(134,239,172,0.5)', letterSpacing:'0.12em', textTransform:'uppercase' }}>
                  Balance
                </p>
              </div>
              <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', gap:12 }}>
                {/* Number + ticker — stacked layout, no overflow */}
                <div style={{ display:'flex', alignItems:'baseline', gap:8, flexWrap:'wrap' }}>
                  <span className="mono" style={{
                    fontWeight:800, color:'#fff', lineHeight:1,
                    fontSize: user.bio_balance >= 100000 ? 20
                            : user.bio_balance >= 10000  ? 24
                            : 28,
                  }}>
                    {fmtBio(user.bio_balance)}
                  </span>
                ...
                {/* USD — right aligned, never truncated */}
          ...
          <div style={{ padding:'8px 20px 24px', display:'flex', flexDirection:'column', gap:14 }}>
            ...
            <div style={{
              ...
              <div style={{ width:'100%' }}>
                <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:6 }}>
                  <BioIcon size={38}/>
                  <p style={{ fontSize:10, color:'rgba(134,239,172,0.5)', textTransform:'uppercase', letterSpacing:'0.1em' }}>Balance</p>
                </div>
                <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', gap:12 }}>
                  <div style={{ display:'flex', alignItems:'baseline', gap:8, flexWrap:'wrap' }}>
                    <span className="mono" style={{
                      ...
                      fontSize: user.bio_balance >= 100000 ? 20
                              : user.bio_balance >= 10000  ? 24
                              : 26,
                    }}>{fmtBio(user.bio_balance)}</span>
                    <span style={{ fontSize:13, fontWeight:700, color:'#22c55e' }}>BIO</span>
                  </div>
                  <p style={{ fontSize:13, color:'#22c55e', flexShrink:0, whiteSpace:'nowrap' }}>
                    ≈ ${(user.bio_balance * prices.bio).toFixed(2)} USD
                  </p>
                </div>
              </div>
            </div>
